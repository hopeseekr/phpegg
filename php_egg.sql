...
INSERT INTO perl_manual VALUES (778,'term::readline','Perl interface to various readline packages. If no real package is found, substitutes stubs instead of basic functions., http://www.perl.com/CPAN-local/doc/manual/html/lib/Term/ReadLine.html\n',NULL);
...
INSERT INTO php_manual VALUES (128,'cpdf_show_xy',' Output text at position','   void cpdf_show_xy (int pdf document, string text, double x-coor,');
INSERT INTO php_manual VALUES (129,'cpdf_text',' Output text with parameters','   void cpdf_text (int pdf document, string text, double x-coor, double');
INSERT INTO php_manual VALUES (130,'cpdf_set_font',' Select the current font face and size','   void cpdf_set_font (int pdf document, string font name, double size,');
INSERT INTO php_manual VALUES (131,'cpdf_set_leading',' Sets distance between text lines','   void cpdf_set leading (int pdf document, double distance)');
...
INSERT INTO php_manual VALUES (133,'cpdf_set_horiz_scaling',' Sets horizontal scaling of text','   void cpdf_set_horiz_scaling (int pdf document, double scale)');
INSERT INTO php_manual VALUES (134,'cpdf_set_text_rise',' Sets the text rise','   void cpdf_set_text_rise (int pdf document, double value)');
...
INSERT INTO php_manual VALUES (136,'cpdf_set_text_pos',' Sets text position','   void cpdf_set_text_pos (int pdf document, double x-coor, double y-coor');
INSERT INTO php_manual VALUES (137,'cpdf_set_char_spacing',' Sets character spacing','   void cpdf_set_char_spacing (int pdf document, double space)');
INSERT INTO php_manual VALUES (138,'cpdf_set_word_spacing',' Sets spacing between words','   void cpdf_set_word_spacing (int pdf document, double space)');
...
INSERT INTO php_manual VALUES (140,'cpdf_stringwidth',' Returns width of text in current font','   double cpdf_stringwidth (int pdf document, string text)');
...
INSERT INTO php_manual VALUES (143,'cpdf_translate',' Sets origin of coordinate system','   void cpdf_translate (int pdf document, double x-coor, double y-coor [,');
INSERT INTO php_manual VALUES (144,'cpdf_scale',' Sets scaling','   void cpdf_scale (int pdf document, double x-scale, double y-scale)');
INSERT INTO php_manual VALUES (145,'cpdf_rotate',' Sets rotation','   void cpdf_rotate (int pdf document, double angle)');
INSERT INTO php_manual VALUES (146,'cpdf_setflat',' Sets flatness','   void cpdf_setflat (int pdf document, double value)');
...
INSERT INTO php_manual VALUES (149,'cpdf_setmiterlimit',' Sets miter limit','   void cpdf_setmiterlimit (int pdf document, double value)');
INSERT INTO php_manual VALUES (150,'cpdf_setlinewidth',' Sets line width','   void cpdf_setlinewidth (int pdf document, double width)');
INSERT INTO php_manual VALUES (151,'cpdf_setdash',' Sets dash pattern','   void cpdf_setdash (int pdf document, double white, double black)');
INSERT INTO php_manual VALUES (152,'cpdf_newpath',' Starts a new path','   void cpdf_newpath (int pdf document)');
INSERT INTO php_manual VALUES (153,'cpdf_moveto',' Sets current point','   void cpdf_moveto (int pdf document, double x-coor, double y-coor [,');
INSERT INTO php_manual VALUES (154,'cpdf_rmoveto',' Sets current point','   void cpdf_rmoveto (int pdf document, double x-coor, double y-coor [,');
INSERT INTO php_manual VALUES (155,'cpdf_curveto',' Draws a curve','   void cpdf_curveto (int pdf document, double x1, double y1, double x2,');
INSERT INTO php_manual VALUES (156,'cpdf_lineto',' Draws a line','   void cpdf_lineto (int pdf document, double x-coor, double y-coor [,');
INSERT INTO php_manual VALUES (157,'cpdf_rlineto',' Draws a line','   void cpdf_rlineto (int pdf document, double x-coor, double y-coor [,');
INSERT INTO php_manual VALUES (158,'cpdf_circle',' Draw a circle','   void cpdf_circle (int pdf document, double x-coor, double y-coor,');
INSERT INTO php_manual VALUES (159,'cpdf_arc',' Draws an arc','   void cpdf_arc (int pdf document, double x-coor, double y-coor, double');
INSERT INTO php_manual VALUES (160,'cpdf_rect',' Draw a rectangle','   void cpdf_rect (int pdf document, double x-coor, double y-coor, double');
...
INSERT INTO php_manual VALUES (168,'cpdf_setgray_fill',' Sets filling color to gray value','   void cpdf_setgray_fill (int pdf document, double value)');
INSERT INTO php_manual VALUES (169,'cpdf_setgray_stroke',' Sets drawing color to gray value','   void cpdf_setgray_stroke (int pdf document, double gray value)');
INSERT INTO php_manual VALUES (170,'cpdf_setgray',' Sets drawing and filling color to gray value','   void cpdf_setgray (int pdf document, double gray value)');
INSERT INTO php_manual VALUES (171,'cpdf_setrgbcolor_fill',' Sets filling color to rgb color value','   void cpdf_setrgbcolor_fill (int pdf document, double red value, double');
INSERT INTO php_manual VALUES (172,'cpdf_setrgbcolor_stroke',' Sets drawing color to rgb color value','   void cpdf_setrgbcolor_stroke (int pdf document, double red value,');
INSERT INTO php_manual VALUES (173,'cpdf_setrgbcolor',' Sets drawing and filling color to rgb color value','   void cpdf_setrgbcolor (int pdf document, double red value, double');
...
INSERT INTO php_manual VALUES (175,'cpdf_set_page_animation',' Sets duration between pages','   void cpdf_set_page_animation (int pdf document, int transition, double');
INSERT INTO php_manual VALUES (176,'cpdf_import_jpeg',' Opens a JPEG image','   int cpdf_import_jpeg (int pdf document, string file name, double');
INSERT INTO php_manual VALUES (177,'cpdf_place_inline_image',' Places an image on the page','   void cpdf_place_inline_image (int pdf document, int image, double');
INSERT INTO php_manual VALUES (178,'cpdf_add_annotation',' Adds annotation','   void cpdf_add_annotation (int pdf document, double llx, double lly,');
...
INSERT INTO php_manual VALUES (223,'strtotime','  Parse about any english textual datetime description','   int strtotime (string time [, int now])');
...
INSERT INTO php_manual VALUES (512,'ImageGammaCorrect','  Apply a gamma correction to a GD image','   int imagegammacorrect (int im, double inputgamma, double outputgamma)');
...
INSERT INTO php_manual VALUES (545,'ImagePsExtendFont','  Extend or condense a font','   bool imagepsextendfont (int font_index, double extend)');
INSERT INTO php_manual VALUES (546,'ImagePsSlantFont','  Slant a font','   bool imagepsslantfont (int font_index, double slant)');
...
INSERT INTO php_manual VALUES (636,'ifx_create_blob',' Creates an blob object','   int ifx_create_blob (int type, int mode, string param)');
INSERT INTO php_manual VALUES (637,'ifx_copy_blob',' Duplicates the given blob object','   int ifx_copy_blob (int bid)');
INSERT INTO php_manual VALUES (638,'ifx_free_blob',' Deletes the blob object','   int ifx_free_blob (int bid)');
INSERT INTO php_manual VALUES (639,'ifx_get_blob',' Return the content of a blob object','   int ifx_get_blob (int bid)');
INSERT INTO php_manual VALUES (640,'ifx_update_blob',' Updates the content of the blob object','   ifx_update_blob (int bid, string content)');
INSERT INTO php_manual VALUES (641,'ifx_blobinfile_mode',' Set the default blob mode for all select','   void ifx_blobinfile_mode (int mode)');
...
INSERT INTO php_manual VALUES (650,'ifxus_seek_slob',' Sets the current file or seek position','   int ifxus_seek_blob (long bid, int mode, long offset)');
...
INSERT INTO php_manual VALUES (734,'deg2rad','  Converts the number in degrees to the radian equivalent','   double deg2rad (double number)');
...
INSERT INTO php_manual VALUES (739,'lcg_value',' Combined linear congruential generator','   double lcg_value(void);');
...
INSERT INTO php_manual VALUES (749,'pi',' Get value of pi','   double pi (void)');
INSERT INTO php_manual VALUES (750,'pow',' Exponential expression','   float pow (float base, float exp)');
INSERT INTO php_manual VALUES (751,'rad2deg','  Converts the radian number to the equivalent number in','   double rad2deg (double number)');
INSERT INTO php_manual VALUES (752,'rand',' Generate a random value','   int rand ([int min [, int max]])');
INSERT INTO php_manual VALUES (753,'round',' Rounds a float','   double round (double val [, int precision])');
...
INSERT INTO php_manual VALUES (874,'SWFDisplayItem->rotateTo',' Rotates the object in global coordinates.','   bool swfdisplayitem->rotateto (double degrees)');
INSERT INTO php_manual VALUES (875,'SWFDisplayItem->Rotate',' Rotates in relative coordinates.','   bool swfdisplayitem->rotate (double ddegrees)');
INSERT INTO php_manual VALUES (876,'SWFDisplayItem->skewXTo',' Sets the X-skew.','   bool swfdisplayitem->skewxto (double degrees)');
INSERT INTO php_manual VALUES (877,'SWFDisplayItem->skewX',' Sets the X-skew.','   bool swfdisplayitem->skewx (double ddegrees)');
INSERT INTO php_manual VALUES (878,'SWFDisplayItem->skewYTo',' Sets the Y-skew.','   bool swfdisplayitem->skewyto (double degrees)');
INSERT INTO php_manual VALUES (879,'SWFDisplayItem->skewY',' Sets the Y-skew.','   bool swfdisplayitem->skewy (double ddegrees)');
INSERT INTO php_manual VALUES (880,'SWFDisplayItem->setDepth',' Sets z-order','   bool swfdisplayitem->setdepth (double depth)');
...
INSERT INTO php_manual VALUES (883,'SWFDisplayItem->setRatio',' Sets the object\'s ratio to ratio.','   void swfdisplayitem->setratio (double ratio)');
...
INSERT INTO php_manual VALUES (898,'SWFGradient->addEntry',' Adds an entry to the gradient list.','   string swfgradient->addentry (double ratio, integer red, integer');
...
INSERT INTO php_manual VALUES (905,'SWFFill->rotateTo',' Sets fill\'s rotation','   int swffill->rotateto (double degrees)');
INSERT INTO php_manual VALUES (906,'SWFFill->skewXTo',' Sets fill x-skew','   int swffill->skewxto (double x)');
INSERT INTO php_manual VALUES (907,'SWFFill->skewYTo',' Sets fill y-skew','   int swffill->skewyto (double y)');
...
INSERT INTO php_manual VALUES (914,'SWFText->setSpacing',' Sets the current font spacing','   int swftext->setspacing (double spacing)');
...
INSERT INTO php_manual VALUES (1210,'PDF_add_launchlink',' Add a launch annotation for current page','   int PDF_add_launchlink (int pdf object, double llx, double lly, double');
INSERT INTO php_manual VALUES (1211,'PDF_add_locallink',' Add a link annotation for current page','   int PDF_add_locallink (int pdf object, double llx, double lly, double');
INSERT INTO php_manual VALUES (1212,'PDF_add_note',' Add a note annotation for current page','   int PDF_add_note (int pdf object, double llx, double lly, double urx,');
INSERT INTO php_manual VALUES (1213,'pdf_add_outline',' Depriciated: Adds bookmark for current page','   Depreciated.');
INSERT INTO php_manual VALUES (1214,'PDF_add_pdflink',' Adds file link annotation for current page','   int PDF_add_pdflink (int pdf object, double llx, double lly, double');
...
INSERT INTO php_manual VALUES (1216,'PDF_add_weblink',' Adds weblink for current page','   int PDF_add_weblink (int pdf object, double llx, double lly, double');
INSERT INTO php_manual VALUES (1217,'PDF_arc',' Draws an arc','   void PDF_arc (int pdf object, double x, double y, double r, double');
INSERT INTO php_manual VALUES (1218,'PDF_arcn',' Draws an arc','   void PDF_arc (int pdf object, double x, double y, double r, double');
INSERT INTO php_manual VALUES (1219,'PDF_attach_file',' Adds a file attachement for current page','   int PDF_attach_file (int pdf object, double llx, double lly, double');
INSERT INTO php_manual VALUES (1220,'PDF_begin_page',' Starts new page','   void PDF_begin_page (int pdf object, double width, double height)');
INSERT INTO php_manual VALUES (1221,'PDF_begin_pattern',' Starts new pattern','   void PDF_begin_pattern (int pdf object, double width, double height,');
INSERT INTO php_manual VALUES (1222,'PDF_begin_template',' Starts new template','   void PDF_begin_template (int pdf object, double width, double height)');
INSERT INTO php_manual VALUES (1223,'PDF_circle',' Draws a circle','   void PDF_circle (int pdf object, double x, double y, double r)');
...
INSERT INTO php_manual VALUES (1232,'PDF_concat',' Concatenate a matrix to the CTM','   void PDF_concat (int pdf object, double a, double b, double c, double');
...
INSERT INTO php_manual VALUES (1234,'PDF_curveto',' Draws a curve','   void PDF_curveto (int pdf object, double x1, double y1, double x2,');
...
INSERT INTO php_manual VALUES (1249,'PDF_get_parameter',' Gets certain parameters','   string PDF_get_parameter (int pdf object, string key [, double');
...
INSERT INTO php_manual VALUES (1252,'PDF_get_value',' Gets certain numerical value','   double PDF_get_value (int pdf object, string key [, double modifier])');
INSERT INTO php_manual VALUES (1253,'PDF_initgraphics',' Resets graphic state','   void PDF_initgraphics (int pdf object)');
INSERT INTO php_manual VALUES (1254,'PDF_lineto',' Draws a line','   void PDF_lineto (int pdf object, double x, double y)');
...
INSERT INTO php_manual VALUES (1256,'PDF_moveto',' Sets current point','   void PDF_moveto (int pdf object, double x, double y)');
...
INSERT INTO php_manual VALUES (1269,'PDF_place_image',' Places an image on the page','   void PDF_place_image (int pdf object, int image, double x, double y,');
INSERT INTO php_manual VALUES (1270,'PDF_rect',' Draws a rectangle','   void PDF_rect (int pdf object, double x, double y, double width,');
INSERT INTO php_manual VALUES (1271,'PDF_restore',' Restores formerly saved environment','   void PDF_restore (int pdf object)');
INSERT INTO php_manual VALUES (1272,'PDF_rotate',' Sets rotation','   void PDF_rotate (int pdf object, double phi)');
INSERT INTO php_manual VALUES (1273,'PDF_save',' Saves the current environment','   void PDF_save (int pdf object)');
INSERT INTO php_manual VALUES (1274,'PDF_scale',' Sets scaling','   void PDF_scale (int pdf object, double x-scale, double y-scale)');
...
INSERT INTO php_manual VALUES (1276,'PDF_setdash',' Sets dash pattern','   void PDF_setdash (int pdf object, double w, double b)');
INSERT INTO php_manual VALUES (1277,'PDF_setflat',' Sets flatness','   void PDF_setflat (int pdf object, double flatness)');
INSERT INTO php_manual VALUES (1278,'PDF_setfont',' Set the current font','   void PDF_setfont (int pdf object, int font, double size)');
INSERT INTO php_manual VALUES (1279,'PDF_setgray',' Sets drawing and filling color to gray value','   void PDF_setgray (int pdf object, double gray)');
INSERT INTO php_manual VALUES (1280,'PDF_setgray_fill',' Sets filling color to gray value','   void PDF_setgray_fill (int pdf object, double gray)');
INSERT INTO php_manual VALUES (1281,'PDF_setgray_stroke',' Sets drawing color to gray value','   void PDF_setgray_stroke (int pdf object, double gray)');
...
INSERT INTO php_manual VALUES (1284,'PDF_setlinewidth',' Sets line width','   void PDF_setlinewidth (int pdf object, double width)');
INSERT INTO php_manual VALUES (1285,'PDF_setmatrix',' Sets current transformation matrix','   void PDF_setmatrix (int pdf object, double a, double b, double c,');
INSERT INTO php_manual VALUES (1286,'PDF_setmiterlimit',' Sets miter limit','   void PDF_setmiterlimit (int pdf object, double miter)');
INSERT INTO php_manual VALUES (1287,'PDF_setpolydash',' Sets complicated dash pattern','   void PDF_setpolydash (int pdf object, double *dasharray)');
INSERT INTO php_manual VALUES (1288,'PDF_setrgbcolor',' Sets drawing and filling color to rgb color value','   void PDF_setrgbcolor (int pdf object, double red value, double green');
INSERT INTO php_manual VALUES (1289,'PDF_setrgbcolor_fill',' Sets filling color to rgb color value','   void PDF_setrgbcolor_fill (int pdf object, double red value, double');
INSERT INTO php_manual VALUES (1290,'PDF_setrgbcolor_stroke',' Sets drawing color to rgb color value','   void PDF_setrgbcolor_stroke (int pdf object, double red value, double');
INSERT INTO php_manual VALUES (1291,'PDF_set_border_color',' Sets color of border around links and','   void PDF_set_border_color (int pdf object, double red, double green,');
INSERT INTO php_manual VALUES (1292,'PDF_set_border_dash',' Sets dash style of border around links and','   void PDF_set_border_dash (int pdf object, double black, double white)');
INSERT INTO php_manual VALUES (1293,'PDF_set_border_style',' Sets style of border around links and','   void PDF_set_border_style (int pdf object, string style, double width)');
...
INSERT INTO php_manual VALUES (1297,'PDF_set_horiz_scaling',' Sets horizontal scaling of text','   void PDF_set_horiz_scaling (int pdf object, double scale)');
...
INSERT INTO php_manual VALUES (1301,'PDF_set_text_pos',' Sets text position','   void PDF_set_text_pos (int pdf object, double x, double y)');
...
INSERT INTO php_manual VALUES (1305,'PDF_set_value',' Sets certain numerical value','   void PDF_set_value (int pdf object, string key, double value)');
...
INSERT INTO php_manual VALUES (1308,'PDF_show_boxed',' Output text in a box','   int PDF_show_boxed (int pdf object, string text, double left, double');
INSERT INTO php_manual VALUES (1309,'PDF_show_xy',' Output text at given position','   void PDF_show_xy (int pdf object, string text, double x, double y)');
INSERT INTO php_manual VALUES (1310,'PDF_skew',' Skews the coordinate system','   void PDF_skew (int pdf object, double alpha, double beta)');
INSERT INTO php_manual VALUES (1311,'PDF_stringwidth',' Returns width of text using current font','   double PDF_stringwidth (int pdf object, string text [, string text [,');
INSERT INTO php_manual VALUES (1312,'PDF_stroke',' Draws line along path','   void PDF_stroke (int pdf object)');
INSERT INTO php_manual VALUES (1313,'PDF_translate',' Sets origin of coordinate system','   void PDF_translate (int pdf object, double tx, double ty)');
...
INSERT INTO php_manual VALUES (1356,'posix_getuid','  Return the real user ID of the current process','   int posix_getuid (void )');
...
INSERT INTO php_manual VALUES (1358,'posix_getgid','  Return the real group ID of the current process','   int posix_getgid (void )');
...
INSERT INTO php_manual VALUES (1580,'swf_viewport',' Select an area for future drawing','   void swf_viewport (double xmin, double xmax, double ymin, double ymax)');
INSERT INTO php_manual VALUES (1581,'swf_ortho','  Defines an orthographic mapping of user coordinates onto','   void swf_ortho (double xmin, double xmax, double ymin, double ymax,');
INSERT INTO php_manual VALUES (1582,'swf_ortho2','  Defines 2D orthographic mapping of user coordinates','   void swf_ortho2 (double xmin, double xmax, double ymin, double ymax)');
INSERT INTO php_manual VALUES (1583,'swf_perspective','  Define a perspective projection transformation','   void swf_perspective (double fovy, double aspect, double near, double');
INSERT INTO php_manual VALUES (1584,'swf_polarview','  Define the viewer\'s position with polar coordinates','   void swf_polarview (double dist, double azimuth, double incidence,');
INSERT INTO php_manual VALUES (1585,'swf_lookat',' Define a viewing transformation','   void swf_lookat (double view_x, double view_y, double view_z, double');
...
INSERT INTO php_manual VALUES (1588,'swf_scale',' Scale the current transformation','   void swf_scale (double x, double y, double z)');
INSERT INTO php_manual VALUES (1589,'swf_translate',' Translate the current transformations','   void swf_translate (double x, double y, double z)');
INSERT INTO php_manual VALUES (1590,'swf_rotate',' Rotate the current transformation','   void swf_rotate (double angle, string axis)');
...
INSERT INTO php_manual VALUES (1642,'similar_text','  Calculate the similarity between two strings','   int similar_text (string first, string second [, double percent])');
...
INSERT INTO php_manual VALUES (1707,'doubleval',' Get double value of a variable','   double doubleval (mixed var)');
...
INSERT INTO php_manual VALUES (1715,'is_double',' Finds whether a variable is a double','   bool is_double (mixed var)');
...
INSERT INTO php_manual VALUES (1723,'is_real',' Finds whether a variable is a real','   bool is_real (mixed var)');
